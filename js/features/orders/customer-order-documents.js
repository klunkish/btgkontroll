...
(function(){
  ...
  const factoryId=()=>String(window.BTG_ACTIVE_FACTORY_ID||window.BTG_CURRENT_FACTORY_ID||window.BTG_FACTORY_ADMIN_STATE?.activeFactoryId||window.BTG_ACCESS_STATE?.factory_id||window.BTG_ACCESS_STATE?.profile?.factory_id||'');
